...
/* Generated by nanopb-0.2.9.2 at Mon Nov  9 21:45:35 2015. */
...
const pb_field_t GetPublicKey_fields[3] = {
    ...
    PB_FIELD2(  2, STRING  , OPTIONAL, CALLBACK, OTHER, GetPublicKey, ecdsa_curve_name, address_n, 0),
    PB_LAST_FIELD
};
...
const pb_field_t RecoveryDevice_fields[8] = {
    ...
    PB_FIELD2(  7, BOOL    , OPTIONAL, STATIC  , OTHER, RecoveryDevice, use_character_cipher, enforce_wordlist, 0),
    PB_LAST_FIELD
};
...
const pb_field_t CharacterRequest_fields[3] = {
    PB_FIELD2(  1, UINT32  , REQUIRED, STATIC  , FIRST, CharacterRequest, word_pos, word_pos, 0),
    PB_FIELD2(  2, UINT32  , REQUIRED, STATIC  , OTHER, CharacterRequest, character_pos, word_pos, 0),
    PB_LAST_FIELD
};

const pb_field_t CharacterAck_fields[4] = {
    PB_FIELD2(  1, STRING  , OPTIONAL, STATIC  , FIRST, CharacterAck, character, character, 0),
    PB_FIELD2(  2, BOOL    , OPTIONAL, STATIC  , OTHER, CharacterAck, delete, character, 0),
    PB_FIELD2(  3, BOOL    , OPTIONAL, STATIC  , OTHER, CharacterAck, done, delete, 0),
    PB_LAST_FIELD
};
...
const pb_field_t CipherKeyValue_fields[8] = {
    ...
    PB_FIELD2(  7, BYTES   , OPTIONAL, CALLBACK, OTHER, CipherKeyValue, iv, ask_on_decrypt, 0),
    PB_LAST_FIELD
};
...
const pb_field_t SignIdentity_fields[5] = {
    ...
    PB_FIELD2(  4, STRING  , OPTIONAL, CALLBACK, OTHER, SignIdentity, ecdsa_curve_name, challenge_visual, 0),
    PB_LAST_FIELD
};
...
const pb_field_t FirmwareUpload_fields[3] = {
    PB_FIELD2(  1, BYTES   , REQUIRED, STATIC  , FIRST, FirmwareUpload, payload_hash, payload_hash, 0),
    PB_FIELD2(  2, BYTES   , REQUIRED, STATIC  , OTHER, FirmwareUpload, payload, payload_hash, 0),
    PB_LAST_FIELD
};
...
const pb_field_t DebugLinkState_fields[15] = {
    ...
    PB_FIELD2( 11, STRING  , OPTIONAL, STATIC  , OTHER, DebugLinkState, recovery_cipher, recovery_word_pos, 0),
    PB_FIELD2( 12, STRING  , OPTIONAL, STATIC  , OTHER, DebugLinkState, recovery_auto_completed_word, recovery_cipher, 0),
    PB_FIELD2( 13, BYTES   , OPTIONAL, STATIC  , OTHER, DebugLinkState, firmware_hash, recovery_auto_completed_word, 0),
    PB_FIELD2( 14, BYTES   , OPTIONAL, STATIC  , OTHER, DebugLinkState, storage_hash, firmware_hash, 0),
    PB_LAST_FIELD
};
 ...
 * field descriptors.
 */
STATIC_ASSERT((pb_membersize(Features, coins[0]) < 65536 && pb_membersize(PublicKey, node) < 65536 && pb_membersize(GetAddress, multisig) < 65536 && pb_membersize(LoadDevice, node) < 65536 && pb_membersize(SimpleSignTx, inputs[0]) < 65536 && pb_membersize(SimpleSignTx, outputs[0]) < 65536 && pb_membersize(SimpleSignTx, transactions[0]) < 65536 && pb_membersize(TxRequest, details) < 65536 && pb_membersize(TxRequest, serialized) < 65536 && pb_membersize(TxAck, tx) < 65536 && pb_membersize(SignIdentity, identity) < 65536 && pb_membersize(DebugLinkState, node) < 65536), YOU_MUST_DEFINE_PB_FIELD_32BIT_FOR_MESSAGES_Initialize_GetFeatures_Features_ClearSession_ApplySettings_ChangePin_Ping_Success_Failure_ButtonRequest_ButtonAck_PinMatrixRequest_PinMatrixAck_Cancel_PassphraseRequest_PassphraseAck_GetEntropy_Entropy_GetPublicKey_PublicKey_GetAddress_Address_WipeDevice_LoadDevice_ResetDevice_EntropyRequest_EntropyAck_RecoveryDevice_WordRequest_WordAck_CharacterRequest_CharacterAck_SignMessage_VerifyMessage_MessageSignature_EncryptMessage_EncryptedMessage_DecryptMessage_DecryptedMessage_CipherKeyValue_CipheredKeyValue_EstimateTxSize_TxSize_SignTx_SimpleSignTx_TxRequest_TxAck_SignIdentity_SignedIdentity_FirmwareErase_FirmwareUpload_DebugLinkDecision_DebugLinkGetState_DebugLinkState_DebugLinkStop_DebugLinkLog_DebugLinkFillConfig)
#endif
