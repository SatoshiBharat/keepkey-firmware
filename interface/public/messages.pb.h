...
typedef struct {
    size_t size;
    uint8_t bytes[32];
} DebugLinkState_firmware_hash_t;

typedef struct {
    size_t size;
    uint8_t bytes[32];
} DebugLinkState_storage_hash_t;
...
#define GetPublicKey_init_default                {0, {0, 0, 0, 0, 0, 0, 0, 0}, {{NULL}, NULL}}
...
#define CipherKeyValue_init_default              {0, {0, 0, 0, 0, 0, 0, 0, 0}, false, "", false, {0, {0}}, false, 0, false, 0, false, 0, {{NULL}, NULL}}
...
#define SignIdentity_init_default                {false, IdentityType_init_default, false, {0, {0}}, false, "", {{NULL}, NULL}}
...
#define GetPublicKey_init_zero                   {0, {0, 0, 0, 0, 0, 0, 0, 0}, {{NULL}, NULL}}
...
#define CipherKeyValue_init_zero                 {0, {0, 0, 0, 0, 0, 0, 0, 0}, false, "", false, {0, {0}}, false, 0, false, 0, false, 0, {{NULL}, NULL}}
...
#define SignIdentity_init_zero                   {false, IdentityType_init_zero, false, {0, {0}}, false, "", {{NULL}, NULL}}
